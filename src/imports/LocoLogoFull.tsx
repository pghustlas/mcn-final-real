import svgPaths from "./svg-a5hkx5uful";
    ...
    <div className="relative size-full" data-name="_레이어_1">
      <svg className="block size-full scale-[2]" fill="none" viewBox="0 0 461 96">
        <g clipPath="url(#clip0_33_861)" id="_ë ì´ì´_1">
          ...
          <g id="Group">
            <path d={svgPaths.p7e41280} fill="var(--fill-0, black)" id="Vector_9" />
            <path d={svgPaths.p1c95b2b0} fill="var(--fill-0, black)" id="Vector_10" />
            <path d={svgPaths.pb394600} fill="var(--fill-0, black)" id="Vector_11" />
            <path d={svgPaths.p3772ff00} fill="var(--fill-0, black)" id="Vector_12" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_33_861">
            <rect fill="white" height="95.9" width="460.16" />
          </clipPath>
        </defs>
      </svg>
    </div>
